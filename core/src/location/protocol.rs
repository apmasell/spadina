...
impl<S: AsRef<str>, B: AsRef<[u8]>> LocationRequest<S, B> {
    ...
    <C as Converter<B>>::Output: AsRef<[u8]>,
  {
    match self {
      ...
      LocationRequest::Internal(data) => LocationRequest::Internal(converter.convert(data)),
    ...
    <R as Referencer<B>>::Output<'a>: AsRef<[u8]>,
  {
    match self {
      ...
      LocationRequest::Delete => LocationRequest::Delete,
      LocationRequest::Internal(data) => LocationRequest::Internal(reference.convert(data)),
