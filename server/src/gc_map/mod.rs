...
{
  type Entry<'a> = GarbageCollectorEntry<'a, K, V, S> where Self: 'a, Self::Key: 'a, Self::Value: 'a ;
  type IterMut<'a> = GarbageIterMut<'a, K, V, S> where Self: 'a, Self::Key: 'a, Self::Value: 'a ;
  type Key = K;
  type Value = V;
