...
pub(crate) fn new(
  ...
  crate::auth::OpenIdConnect::new(DatabaseOpenIdConnect { client, registration })
}
...
impl crate::auth::OpenIdConnectProvider for DatabaseOpenIdConnect {
  ...
  async fn client(self: &Self, _: &str, _: &crate::database::Database) -> Option<&openidconnect::core::CoreClient> {
    Some(&self.client)
  }
  ...
  async fn registration_client(&self, _: &Self::RegistrationTarget, _: &crate::database::Database) -> Option<&openidconnect::core::CoreClient> {
    Some(&self.client)
  }
