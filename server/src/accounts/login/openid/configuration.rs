...
impl OIConnectEndpoint {
  fn into_url_and_name(self) -> (String, String) {
    match self {
      ...
      OIConnectEndpoint::Apple => ("https://appleid.apple.com".to_string(), "Apple".to_string()),
      OIConnectEndpoint::Facebook => ("https://www.facebook.com".to_string(), "Facebook".to_string()),
      OIConnectEndpoint::Google => ("https://accounts.google.com".to_string(), "Google".to_string()),
      OIConnectEndpoint::LinkedIn => ("https://www.linkedin.com".to_string(), "LinkedIn".to_string()),
      OIConnectEndpoint::Microsoft { tenant } => (
        format!(
