...
pub struct AltitudeMixer<T: crate::convert::IntoBevy> {
  bottom_bevy: T::Bevy,
  bottom_limit: u32,
  bottom_value: T,
  top_bevy: T::Bevy,
...
impl<T: crate::convert::IntoBevy> AltitudeMixer<T> {
  ...
  pub fn register(&mut self, z: u32) -> T::Bevy {
    if z >= self.top_limit {
      ...
      match T::mix(vec![(fraction, self.top_value.clone()), (1.0 - fraction, self.bottom_value.clone())]) {
