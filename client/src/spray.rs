...
pub struct ConvertedModel<M, C, I> {
  ...
  pub lights: Vec<spadina_core::asset::Light<I, C>>,
}
impl ConvertedModel<u32, u32, u32> {
  fn new(
    source: spadina_core::asset::AssetAnyModel,
  ...
  fn bind<A: crate::convert::ExtractArgument>(
    ...
    ConvertedModel<
      ...
      crate::convert::LocalBevyValue<spadina_core::asset::Color>,
    ...
    Some(ConvertedModel {
      ...
      lights: self
        ...
        .map(|light| match light {
          spadina_core::asset::Light::Point { position, color, intensity } => match (
            ...
            (Some(color), Some(intensity)) => Some(spadina_core::asset::Light::Point { position: position.clone(), color, intensity }),
            _ => None,
          },
        })
        .collect::<Option<_>>()?,
  ...
  >
{
  pub fn instantiate<'w, 's, 'a>(
    ...
    z: u32,
    seed: i32,
    angle: &spadina_core::asset::Angle,
    vertical: &bevy::math::Quat,
    vertical_perturbation: &spadina_core::asset::Perturbation,
    state: &mut crate::convert::WorldBuildingState,
    ...
    spawn.with_children(|builder| {
      ...
      for light in &self.lights {
        let mut spawn = builder.spawn();
        match light {
          spadina_core::asset::Light::Point { position, color, intensity } => {
...
pub struct ConvertedSpray {
  pub angle: spadina_core::asset::Angle,
  pub elements: Vec<(
    u8,
    ConvertedModel<
      crate::convert::LocalBevyValue<u32>,
  ...
  pub vertical: bool,
  pub vertical_perturbation: spadina_core::asset::Perturbation,
}
impl ConvertedSpray {
  pub fn new(
    source: spadina_core::asset::Spray<spadina_core::asset::Loaded<spadina_core::asset::AssetAnyModel>>,
    meshes: &mut bevy::prelude::Assets<bevy::render::mesh::Mesh>,
    seed: i32,
    state: &mut crate::convert::WorldBuildingState,
...
pub(crate) enum ConvertedWall {
  Solid {
    width: f32,
    width_perturbation: spadina_core::asset::Perturbation,
...
impl ConvertedWall {
  pub fn new(
    source: spadina_core::asset::Wall<spadina_core::asset::Loaded<spadina_core::asset::AssetAnyModel>>,
    meshes: &mut bevy::prelude::Assets<bevy::render::mesh::Mesh>,
    seed: i32,
    state: &mut crate::convert::WorldBuildingState,
  ) -> Option<ConvertedWall> {
    Some(match source {
      spadina_core::asset::Wall::Fence { angle, posts, vertical, vertical_perturbation } => ConvertedWall::Fence {
        angle,
        posts: posts
          .into_iter()
          .map(|element| match ConvertedModel::new(element.model.into_inner(), meshes).bind(&element.arguments, &(), seed, state) {
      ...
      spadina_core::asset::Wall::Solid { width, width_perturbation, material } => {
        ConvertedWall::Solid { width, width_perturbation, material: state.materials.get(material as usize)?.clone() }
      }
      spadina_core::asset::Wall::Gate { angle, arguments, identifier, model, vertical, vertical_perturbation } => ConvertedWall::Gate {
        angle,
        model: ConvertedModel::new(model.into_inner(), meshes).bind(&arguments, &identifier, seed, state)?,
        vertical,
        vertical_perturbation,
      },
      spadina_core::asset::Wall::Block { angle, arguments, identifier, model, vertical, vertical_perturbation } => ConvertedWall::Block {
        angle,
