...
pub enum MaterialBuilder {
  PuzzleBool(String, u32, u32, puzzleverse_core::asset::Transition),
  PuzzleNum(String, u32, Vec<u32>, puzzleverse_core::asset::Transition),
  SettingBool(String, u32, u32, puzzleverse_core::asset::Transition),
  SettingNum(String, u32, Vec<u32>, puzzleverse_core::asset::Transition),
}

#[derive(TypeUuid, Clone, Debug)]
#[uuid = "ad80965f-48c3-4da8-8fbc-2a8236f74985"]
struct AestheticMaterial {
  aesthetic: puzzleverse_core::asset::Aesthetic,
